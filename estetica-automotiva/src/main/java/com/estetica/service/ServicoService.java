...
public class ServicoService {
    ...
    public void salvar(Servico servico) {
        // garante que id vazio vira null para o MongoDB gerar um ObjectId novo
    ...
    public void desativar(String id) {
        repo.findById(id).ifPresent(s -> { s.setAtivo(false); repo.save(s); });
    }

    public void reativar(String id) {
        repo.findById(id).ifPresent(s -> { s.setAtivo(true); repo.save(s); });
    }
