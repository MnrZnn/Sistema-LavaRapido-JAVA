...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (servicoRepo.findByAtivoTrue().isEmpty()) {
            criarServico("Lavagem Simples", "Lavagem externa com água e sabão.", new BigDecimal("40.00"));
            criarServico("Lavagem Completa", "Lavagem interna e externa com aspiração.", new BigDecimal("80.00"));
            criarServico("Lavagem com Cera", "Lavagem completa com aplicação de cera protetora.", new BigDecimal("120.00"));
            criarServico("Polimento", "Polimento para remoção de riscos superficiais.", new BigDecimal("200.00"));
            criarServico("Higienização Interna", "Limpeza profunda do interior do veículo.", new BigDecimal("180.00"));
        }
    }

    private void criarServico(String nome, String desc, BigDecimal preco) {
